...
//            graphics2D.drawString(content, (int)x, (int)baseY);
            ...
            BufferedImage bimg = null;
                String backgroundimgPath = "D:/Users/CHENJH/Desktop/test/createImage.jpg";
                bimg = ImageIO.read(new File(backgroundimgPath));
                if(bimg!=null){
                    graphics2D.drawImage(bimg, 350, 220, 180, 180, null);
                }
